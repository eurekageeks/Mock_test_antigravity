    ...
    <div className="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-screen p-6 sm:p-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className={`p-4 rounded-3xl border ${attempt.pending_subjective_count > 0 ? 'bg-amber-50 border-amber-200 dark:bg-amber-900/10 dark:border-amber-800/50' : 'bg-sky-50 border-sky-200 dark:bg-sky-900/10 dark:border-sky-800/50'}`}>
            ...
            <div className="flex flex-col items-center justify-center pb-2">
              {attempt.pending_subjective_count > 0 ? (
                <>
                  <p className="text-xl font-black text-amber-600 mt-2 uppercase">
                    Pending
                  </p>
                  <p className="text-xs font-bold mt-2 text-amber-500 animate-pulse uppercase">
                    To Admin
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-xs font-bold mt-2 text-sky-500">
                    GRADED
                  </p>
                </>
              )}
          ...
          {/* Final Score */}
          <div className={`p-4 rounded-3xl border ${attempt.pending_subjective_count > 0 ? 'bg-amber-50 border-amber-200 dark:bg-amber-900/10 dark:border-amber-800/50' : (isPassed ? 'bg-emerald-50 border-emerald-200 dark:bg-emerald-900/10 dark:border-emerald-800/50' : 'bg-rose-50 border-rose-200 dark:bg-rose-900/10 dark:border-rose-800/50')}`}>
              ...
              {attempt.pending_subjective_count > 0 ? (
                ...
                <>
                  ...
                  <p className={`text-xs font-bold mt-2 ${isPassed ? 'text-emerald-500' : 'text-rose-500'}`}>
                    {isPassed ? 'PASSED OVERALL' : 'FAILED OVERALL'}
                  </p>
                </>
              )}
            </div>
