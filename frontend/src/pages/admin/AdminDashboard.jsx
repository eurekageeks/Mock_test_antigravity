      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link 
              to="/admin/backup"
              className="p-6 bg-white dark:bg-slate-800 rounded-3xl border border-emerald-500/20 dark:border-emerald-500/20 hover:border-emerald-500 dark:hover:border-emerald-500 shadow-sm flex justify-between items-center group transition-colors duration-200"
            >
              <div>
                <span className="font-bold text-base text-emerald-600 dark:text-emerald-400 block flex items-center gap-1.5">
                  <Database className="h-4 w-4" />
                  <span>Backup & Restore</span>
                </span>
                <span className="text-xs text-slate-400 mt-1 block">Download or upload database.</span>
              </div>
              <ChevronRight className="h-5 w-5 text-emerald-500 group-hover:translate-x-1 transition-all" />
            </Link>
          </div>
        </div>
